...
| bulgarian | 159 | 422,087 | 88,628/92,753 | 95.55% | 2.78s | OK |
...
| magic | 106 | 848,517 | 87,517/100,937 | 86.70% | 5.68s | OK |
| manyarguments | 40 | 156 | 10/20 | 50.00% | 0.06s | OK |
| multiarray | 115 | 2,169 | 221/273 | 80.95% | 0.07s | OK |
...
| queens | 171 | 1,034,392 | 80,864/103,290 | 78.29% | 5.72s | OK |
...
| **合计**（同目录 `./test.sh` 输出，含参数优化：INTEGERRS 8→16 + STORERS 4→8；其中 17/17（非 pi）基线 TOTAL **8,659,277**）| — | **196,334,706** | **36,820,013/44,392,178** | **82.94%** | — | **18/18** |
